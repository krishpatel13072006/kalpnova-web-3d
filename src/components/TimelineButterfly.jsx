...
export default function TimelineButterfly({ scale = 0.8 }) {
  const isPink = true;
  const ct = "pink";

  let color1 = "#FFFFFF"; // White
  let color2 = "#FF69B4"; // Pink
  let color3 = "#FFD700"; // Yellow
  let baseScale = scale; // Passed scale or default 0.8
    ...
    <>
      ...
      >
        ...
        <svg className={`bfly-wing-${ct} bfly-lw-${ct}`} viewBox="0 0 100 100" preserveAspectRatio="none">
          ...
          {/* Inner details omitted for brevity or can add back if needed */}

...
export default function Terminal({ 
  ...
  return (
    <div className="w-full max-w-[400px] md:max-w-6xl mx-auto rounded-[32px] md:rounded-[20px] overflow-hidden border border-white/10 bg-[#0d0f14] shadow-2xl transition-all duration-500">
      ...
      <div className="flex items-center justify-between px-5 py-4 md:px-6 md:py-4 bg-[#1a1b1e] border-b border-white/5">
        ...
        <div className="flex-1 max-w-[140px] md:max-w-2xl px-3 py-1 bg-black/40 border border-white/10 rounded-full flex items-center justify-center gap-2 group transition-all duration-300 hover:bg-black/60 mx-1 md:mx-0">
          ...
          <span className="text-[8px] md:text-[11px] text-zinc-500 font-mono tracking-tight truncate lowercase">
            {url}
          </span>
        </div>
        ...
        <div className="w-10 md:w-20 flex justify-end">
          <a
            ...
            className="flex items-center justify-center w-7 h-7 md:w-auto md:h-auto md:px-3 md:py-1 bg-white/5 border border-white/10 rounded-full md:rounded-md text-[8px] md:text-[10px] font-bold text-zinc-400 uppercase tracking-widest hover:bg-white/10 hover:text-white transition-all duration-200"
          >

        ...
        {items.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              <div 
                className={`absolute inset-0 border-2 rounded-2xl transition-all duration-1000 pointer-events-none ${
                    isActive ? 'border-[#ff6b2b]/40 shadow-[inset_0_0_50px_rgba(255,107,43,0.2)]' : 'border-transparent'
                  }`}
              />
            </div>
          );

    ...
    <section className="section overflow-hidden py-20 bg-bg">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-14 max-w-xl">
          <span className="inline-flex items-center justify-center mb-4 px-4 h-8 text-[10px] tracking-[0.2em] 
                           rounded-full border border-orange-500/30 bg-orange-500/10
                           text-orange-500 font-bold uppercase backdrop-blur-sm pt-[2px]">
            CLIENTS
          </span>

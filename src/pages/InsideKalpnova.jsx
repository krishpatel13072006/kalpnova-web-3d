...
export default function InsideKalpnova() {
  ...
  return (
    <div className="w-full min-h-screen bg-neutral-950 text-white flex flex-col items-center justify-center relative overflow-hidden p-6">
      ...
      <div className="z-10 text-center mb-16 animate-fade-in mt-10">
        <h1 className="font-heading text-5xl md:text-7xl font-black tracking-tighter mb-4 uppercase">Inside Kalpnova</h1>
